  ...
  return (
    <div className="task-list">
      ...
      <div className="task-item">
        <button className="add-task" onClick={saveNewTask}>
          +
        </button>
        <input
          className="add-task"
    ...
    <div className="task-item">
      ...
      {editing ? (
        <div className="display-text">
          ...
          />
          <button className="edit-button" onClick={saveText}>
            {" "}
            ✓
          </button>
        </div>
      ) : (
        <span className={`display-text ${extraClass}`} onClick={toggleEditing}>
          {text}
        </span>
      )}
